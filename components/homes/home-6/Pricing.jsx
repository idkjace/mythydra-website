                              ...
                              return (
                                <li key={i} className="hstack items-start gap-2">
                                  {isIncluded ? (
                                    ...
                                    <i className="cstack w-24px h-24px bg-gray-200 text-gray-500 rounded-circle unicon-times fw-bold" />
                                  )}
                                  <span className={`d-inline ${!isIncluded ? 'text-gray-500 line-through' : ''}`}>
                                    {featureText}
                                  </span>
                                </li>
                              );
